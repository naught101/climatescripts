...
##################################################
#
# ccrc-top:  check memory usage on multiple servers
#        usage: ccrc-top.sh -h
#
...
#
#     alias ccrc-top.sh='/dir/to/ccrc-top.sh'
#
#
# Eytan Rocheta
# erocheta@gmail.com
...
function usage
{
    ...
    echo " Usage:   ccrc-top.sh [-u zID] [-m mem_val] "
    echo "     e.g. ccrc-top.sh  -u zID 2 squall 4 -o"
